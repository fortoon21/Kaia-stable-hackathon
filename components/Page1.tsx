...
export default function Page1() {
  ...
  return (
    ...
    >
      ...
      <footer className="relative w-full h-[60px] flex items-center justify-between px-4 bg-[#08131f] border-t border-[#14304e]">
        <div className="flex space-x-4 text-[#435971] text-xs">
