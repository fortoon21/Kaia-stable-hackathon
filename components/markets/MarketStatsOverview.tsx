  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div className="bg-surface-3 border border-line-soft rounded-lg p-4 shadow-1">
        <div className="text-body text-sm mb-1 font-heading text-sage-600">
          Total Liquidity
        </div>
      ...
      <div className="bg-surface-3 border border-line-soft rounded-lg p-4 shadow-1">
        ...
        <div className="text-muted text-sm text-sage-400">
          {totalAssets} Assets
        </div>
      </div>
      <div className="bg-surface-3 border border-line-soft rounded-lg p-4 shadow-1">
        ...
        <div className="text-2xl font-bold font-heading text-heading text-primary-100">
          {bestROEData.roe}
        </div>
        <div className="text-sage-400 text-sm font-heading">
          {bestROEData.pairName}
        </div>
      </div>
    </div>
  );
